...
> 配套文档：完整需求 / 规格 / Roadmap 见 [`../README.md`](../README.md)。
...
- **现状**：项目仅有设计文档 [`../README.md`](../README.md)，**无任何代码、无 `package.json`**。
- **没做什么**：未开始任何实现（Milestone 0 及以后均未动）。
- **下一步**：按 README 第 6 节 Roadmap 从 **Milestone 0（项目初始化）** 起步——`manifest.json`
